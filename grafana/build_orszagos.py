...
def build() -> dict:
    ...
    return {
        ...
        "links": [{"asDropdown": False, "icon": "external link", "includeVars": False,
                   "keepTime": False, "tags": [], "targetBlank": False,
                   "title": "Országos szezonális összevetés", "tooltip": "", "type": "link",
                   "url": "/d/orszagos-vizallas-szezonalis"},
                  {"asDropdown": False, "icon": "external link", "includeVars": False,
                   "keepTime": False, "tags": [], "targetBlank": False,
                   "title": "Dombori vízállás", "tooltip": "", "type": "link",
                   "url": "/d/dombori-vizallas"}],
        "panels": panels, "preload": False, "refresh": "5m", "schemaVersion": 42,
        "tags": ["dombori", "vizallas", "duna", "orszagos"],
